document.addEventListener('DOMContentLoaded', function() {
    ...
    const images = [
        ...
        { src: "images/make9.jpg", desc: "Un grand pot a crayon tour effeil pour les fan de paris" },
        ...
        { src: "images/make12.jpg", desc: "Un tee du stade toulousain parfait pour tout fan de rugby" }
    ];
    let index = 0;
